...
If you want to make any corrections or updates that will improve the overall user experience, then create a fork, make your changes and start a pull request.
